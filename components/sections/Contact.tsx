            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="mt-4 text-slate-600 max-w-2xl mx-auto">
                        Starting a new project or just want to chat? Feel free to reach out. I'm currently available for freelance projects and open to new opportunities.
                    </p>
                </motion.div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center text-slate-600 group">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium">Pathum Thani, Thailand</p>
                                </div>
                            </div>
