    ...
    return (
        <section id="contact" className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">{t(translations.contact.title, displayLang)}</h2>
                    <div className="w-20 h-1 bg-blue-600 mx-auto rounded-full"></div>
                    <p className="mt-4 text-slate-600 max-w-2xl mx-auto">
                        {t(translations.contact.subtitle, displayLang)}
                    </p>
                </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
                    ...
                    >
                        <h3 className="text-2xl font-bold mb-6">{t(translations.contact.info, displayLang)}</h3>
                        <div className="space-y-6">
                            <a href="mailto:p.paramet2002@gmail.com" className="flex items-center text-slate-600 hover:text-blue-600 transition-colors group">
                                ...
                                <div>
                                    <p className="text-sm text-gray-500">{t(translations.contact.emailMe, displayLang)}</p>
                            ...
                            <div className="flex items-center text-slate-600 group">
                                ...
                                <div>
                                    <p className="text-sm text-gray-500">{t(translations.contact.callMe, displayLang)}</p>
                            ...
                            <div className="flex items-center text-slate-600 group">
                                ...
                                <div>
                                    <p className="text-sm text-gray-500">{t(translations.contact.location, displayLang)}</p>
                                    <p className="font-medium">{t(translations.contact.locationValue, displayLang)}</p>
                                </div>
                            </div>

                            <div className="pt-8">
                                <h4 className="text-lg font-bold mb-4">{t(translations.contact.followMe, displayLang)}</h4>
                    ...
                    >
                        <form className="space-y-6">
                            <div>
                                <label htmlFor="name" className="block text-sm font-medium text-slate-700 mb-2">{t(translations.contact.nameLabel, displayLang)}</label>
                                <input
                                    type="text"
                                    id="name"
                                    ...
                                    placeholder={t(translations.contact.namePlaceholder, displayLang)}
                                    suppressHydrationWarning
                                />
                            </div>
                            <div>
                                <label htmlFor="email" className="block text-sm font-medium text-slate-700 mb-2">{t(translations.contact.emailLabel, displayLang)}</label>
                                <input
                                    type="email"
                                    id="email"
                                    className="w-full px-4 py-3 rounded-lg border border-slate-200 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all"
                                    placeholder={t(translations.contact.emailPlaceholder, displayLang)}
                                    suppressHydrationWarning
                                />
                            </div>
                            <div>
                                <label htmlFor="message" className="block text-sm font-medium text-slate-700 mb-2">{t(translations.contact.messageLabel, displayLang)}</label>
                                <textarea
                                    id="message"
                                    rows={4}
                                    ...
                                    placeholder={t(translations.contact.messagePlaceholder, displayLang)}
                                    suppressHydrationWarning
                                ></textarea>
                            </div>
                            <button
                                ...
                                suppressHydrationWarning
                            >
                                {t(translations.contact.sendBtn, displayLang)}
                            </button>
                        </form>
                    </motion.div>
                </div>
